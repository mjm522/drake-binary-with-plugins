...
class optitrack_frame_t
{
    public:
        ...
        /// # of marker sets in this frame of data
        ...
        /// host defined time difference between capture and send, not necessarily frame accurate.
        int64_t    timecode;
