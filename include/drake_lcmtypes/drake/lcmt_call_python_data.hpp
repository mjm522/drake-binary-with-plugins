...
class lcmt_call_python_data
{
    ...
    public:
        /// For data_type.
        static constexpr int8_t   REMOTE_VARIABLE_REFERENCE = 0;
        static constexpr int8_t   DOUBLE = 1;
        static constexpr int8_t   CHAR = 2;
        static constexpr int8_t   LOGICAL = 3;
        static constexpr int8_t   INT = 4;
        /// For shape_type.
        static constexpr int8_t   MATRIX = 0;
        static constexpr int8_t   VECTOR = 1;
        static constexpr int8_t   SCALAR = 2;
