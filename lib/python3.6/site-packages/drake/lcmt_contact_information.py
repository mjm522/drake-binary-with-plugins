...
class lcmt_contact_information(object):
    ...
    __typenames__ = ["int64_t", "string", "int32_t", "int32_t", "double", "double", "double", "double", "double", "int8_t"]

    __dimensions__ = [None, None, None, None, [3, "num_contact_points"], [3], None, None, None, None]
