...
class lcmt_resolved_contact(object):
    ...
    __typenames__ = ["int64_t", "string", "int32_t", "int32_t", "double", "int32_t", "double", "double", "double", "double"]

    __dimensions__ = [None, None, None, None, ["num_all_basis"], None, [3, "num_contact_points"], [3, "num_contact_points"], [6], [3]]
