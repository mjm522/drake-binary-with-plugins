...
class lcmt_qp_input(object):
    ...
    __typenames__ = ["int64_t", "int32_t", "drake.lcmt_contact_information", "int32_t", "drake.lcmt_desired_body_motion", "drake.lcmt_desired_dof_motions", "drake.lcmt_desired_centroidal_momentum_dot", "double"]

    __dimensions__ = [None, None, ["num_contacts"], None, ["num_desired_body_motions"], None, None, None]
