...
class lcmt_body_motion_data(object):
    ...
    __typenames__ = ["int64_t", "string", "drake.lcmt_piecewise_polynomial", "double", "double", "double", "double", "double", "double", "double", "boolean", "boolean"]

    __dimensions__ = [None, None, None, [4], [3], [3], [3], None, None, [6], None, None]
