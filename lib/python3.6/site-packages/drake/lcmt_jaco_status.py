...
class lcmt_jaco_status(object):
    ...
    __typenames__ = ["int64_t", "int32_t", "double", "double", "double", "double", "int32_t", "double", "double", "double", "double"]

    __dimensions__ = [None, None, ["num_joints"], ["num_joints"], ["num_joints"], ["num_joints"], None, ["num_fingers"], ["num_fingers"], ["num_fingers"], ["num_fingers"]]
