...
class lcmt_qp_controller_input(object):
    ...
    __typenames__ = ["boolean", "int64_t", "drake.lcmt_zmp_data", "int32_t", "drake.lcmt_support_data", "int32_t", "drake.lcmt_body_motion_data", "int32_t", "drake.lcmt_body_wrench_data", "drake.lcmt_whole_body_data", "int32_t", "drake.lcmt_joint_pd_override", "string"]

    __dimensions__ = [None, None, None, None, ["num_support_data"], None, ["num_tracked_bodies"], None, ["num_external_wrenches"], None, None, ["num_joint_pd_overrides"], None]
