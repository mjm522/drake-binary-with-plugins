...
class lcmt_robot_state(object):
    ...
    __typenames__ = ["int64_t", "int32_t", "string", "int32_t", "int32_t", "string", "float", "float"]

    __dimensions__ = [None, None, ["num_robots"], None, ["num_joints"], ["num_joints"], ["num_joints"], ["num_joints"]]
