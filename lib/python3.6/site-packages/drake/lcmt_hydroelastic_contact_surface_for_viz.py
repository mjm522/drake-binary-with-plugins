...
class lcmt_hydroelastic_contact_surface_for_viz(object):
    __slots__ = ["body1_name", "body2_name", "centroid_W", "force_C_W", "moment_C_W", "num_triangles", "triangles", "num_quadrature_points", "quadrature_point_data"]

    __typenames__ = ["string", "string", "double", "double", "double", "int32_t", "drake.lcmt_hydroelastic_contact_surface_tri_for_viz", "int32_t", "drake.lcmt_hydroelastic_quadrature_per_point_data_for_viz"]

    __dimensions__ = [None, None, [3], [3], [3], None, ["num_triangles"], None, ["num_quadrature_points"]]
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0x612ef9ac5da59a85+ drake.lcmt_hydroelastic_contact_surface_tri_for_viz._get_hash_recursive(newparents)+ drake.lcmt_hydroelastic_quadrature_per_point_data_for_viz._get_hash_recursive(newparents)) & 0xffffffffffffffff
