...
class image_t(object):
    ...
    __typenames__ = ["robotlocomotion.header_t", "int32_t", "int32_t", "int32_t", "int32_t", "byte", "boolean", "int8_t", "int8_t", "int8_t"]
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0xcc69e8044fc49594+ robotlocomotion.header_t._get_hash_recursive(newparents)) & 0xffffffffffffffff
