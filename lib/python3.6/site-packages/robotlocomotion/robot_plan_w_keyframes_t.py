...
class robot_plan_w_keyframes_t(object):
    ...
    __typenames__ = ["int64_t", "string", "int32_t", "int32_t", "int32_t", "boolean", "boolean", "bot_core.robot_state_t", "int32_t", "int32_t", "robotlocomotion.grasp_transition_state_t", "int32_t", "byte"]

    __dimensions__ = [None, None, None, None, None, ["num_states"], ["num_states"], ["num_states"], ["num_states"], None, ["num_grasp_transitions"], None, ["num_bytes"]]
