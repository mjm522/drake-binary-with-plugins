...
class grasp_transition_state_t(object):
    ...
    __typenames__ = ["int64_t", "int32_t", "bot_core.position_3d_t", "boolean", "int16_t", "boolean", "int32_t", "string", "double"]

    __dimensions__ = [None, None, None, None, None, None, None, ["num_joints"], ["num_joints"]]
