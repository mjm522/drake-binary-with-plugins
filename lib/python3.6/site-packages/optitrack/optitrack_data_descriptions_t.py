...
class optitrack_data_descriptions_t(object):
    ...
    __typenames__ = ["int32_t", "optitrack.optitrack_marker_set_description_t", "int32_t", "optitrack.optitrack_rigid_body_description_t"]

    __dimensions__ = [None, ["num_marker_sets"], None, ["num_rigid_bodies"]]
