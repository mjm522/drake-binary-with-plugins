...
class optitrack_rigid_body_t(object):
    ...
    __typenames__ = ["int32_t", "float", "float", "int32_t", "float", "int32_t", "float", "float", "int16_t"]

    __dimensions__ = [None, [3], [4], None, ["num_markers", 3], ["num_markers"], ["num_markers"], None, None]
