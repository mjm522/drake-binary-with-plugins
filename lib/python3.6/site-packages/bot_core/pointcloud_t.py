...
class pointcloud_t(object):
    ...
    __typenames__ = ["int64_t", "int32_t", "string", "int32_t", "float", "int32_t", "string", "float"]

    __dimensions__ = [None, None, None, None, ["n_points", 3], None, ["n_channels"], ["n_channels", "n_points"]]
