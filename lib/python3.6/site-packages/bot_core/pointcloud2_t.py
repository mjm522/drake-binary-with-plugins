...
class pointcloud2_t(object):
    ...
    __typenames__ = ["int64_t", "int32_t", "string", "int32_t", "int32_t", "int32_t", "bot_core.pointfield_t", "boolean", "int32_t", "int32_t", "int32_t", "byte", "boolean"]

    __dimensions__ = [None, None, None, None, None, None, ["nfields"], None, None, None, None, ["data_nbytes"], None]
